...
from multi_doc_chat.pipelines.data_ingestion import ChatIngestor
from multi_doc_chat.pipelines.data_retriever import ConversationalRAG
...
def test_document_ingestion_and_rag():
    try:
        test_files = [
            "C:/Users/777kr/Desktop/LLMOPS/data/NIPS-2017-attention-is-all-you-need-Paper.pdf",
        ]
